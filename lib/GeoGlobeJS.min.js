...
"View2D/Service/VTS.js","View2D/Service/WMS.js","View2D/Service/WMTS.js","View2D/Service/DTJ.js","View2D/Statistics/GeoStatisticsService.js","View2D/ElementContainer/ElementContainer.js","View2D/ElementContainer/MaptalksEC.js","View2D/tool/Lang.js","View2D/tool/Lang/en.js","View2D/tool/Lang/zh-CN.js"],b="",c=/(^|(.*?\/))(GeoGlobeJSAPI.js)(\?|$)/,d=document.getElementsByTagName("script"),e=0,f=d.length;e<f;e++){var g=d[e].getAttribute("src");if(g&&(g=g.match(c))){b=g[1];break}}c=Array(a.length);e=
0;for(f=a.length;e<f;e++)c[e]="<script src='"+b+a[e]+"'><\/script>";c.length>0&&document.write(c.join(""))}GeoGlobe.scriptName=!GeoGlobe.singleFile?"GeoGlobeJSAPI/GeoGlobeJSAPI.js":"GeoGlobeJS.min.js";GeoGlobe.getScriptLocation=function(){for(var a="",b=RegExp("(^|(.*?\\/))("+GeoGlobe.scriptName+")(\\?|$)"),c=document.getElementsByTagName("script"),d=0,e=c.length;d<e;d++){var f=c[d].getAttribute("src");if(f&&(f=f.match(b))){a=f[1];break}}return a};GeoGlobe.imagesPath="";GeoGlobe.createNS=function(a){for(var a=
a.split("."),b=window,c=0;c<a.length;c++)b[a[c]]||(b[a[c]]={}),b=b[a[c]]};GeoGlobe.VERSION_NUMBER="GeoGlobeJSAPI 6.4 -- $Version: 1.32.171011 build-20171011 $"})();GeoGlobe.Class=function(){var a=arguments.length,b=arguments[0],c=arguments[a-1],d=typeof c.initialize=="function"?c.initialize:function(){b.prototype.initialize.apply(this,arguments)};a>1?[d,b].concat(Array.prototype.slice.call(arguments).slice(1,a-1),c):d.prototype=c;return d};
...
"none")};GeoGlobe.DOM.enableDrag=function(){d&&(c[d]=e)};var f=a(["transform","WebkitTransform"]);GeoGlobe.DOM.setTransform=function(a,b){a.style[f]=b};GeoGlobe.DOM.suppressClick=function(){window.addEventListener("click",b,!0);window.setTimeout(function(){window.removeEventListener("click",b,!0)},0)};GeoGlobe.DOM.mousePos=function(a,b){var c=a.getBoundingClientRect(),b=b.touches?b.touches[0]:b;return new Point(b.clientX-c.left-a.clientLeft,b.clientY-c.top-a.clientTop)};GeoGlobe.DOM.touchPos=function(a,
b){for(var c=a.getBoundingClientRect(),d=[],e=b.type==="touchend"?b.changedTouches:b.touches,f=0;f<e.length;f++)d.push(new Point(e[f].clientX-c.left-a.clientLeft,e[f].clientY-c.top-a.clientTop));return d};GeoGlobe.DOM.remove=function(a){a.parentNode&&a.parentNode.removeChild(a)}})();GeoGlobe.Util=GeoGlobe.Util||{};GeoGlobe.Util.getElement=function(){for(var a=[],b=0,c=arguments.length;b<c;b++){var d=arguments[b];typeof d=="string"&&(d=document.getElementById(d));if(arguments.length==1)return d;a.push(d)}return a};
GeoGlobe.Util.isElement=function(a){return!!(a&&a.nodeType===1)};GeoGlobe.Util.isArray=function(a){return Object.prototype.toString.call(a)==="[object Array]"};GeoGlobe.Util.removeItem=function(a,b){for(var c=a.length-1;c>=0;c--)a[c]==b&&a.splice(c,1);return a};GeoGlobe.Util.indexOf=function(a,b){if(typeof a.indexOf=="function")return a.indexOf(b);else{for(var c=0,d=a.length;c<d;c++)if(a[c]==b)return c;return-1}};GeoGlobe.Util.dotless=/\./g;GeoGlobe.IMAGE_RELOAD_ATTEMPTS=0;
GeoGlobe.Util.alphaHackNeeded=null;GeoGlobe.Util.alphaHack=function(){if(GeoGlobe.Util.alphaHackNeeded==null){var a=navigator.appVersion.split("MSIE"),a=parseFloat(a[1]),b=!1;try{b=!!document.body.filters}catch(c){}GeoGlobe.Util.alphaHackNeeded=b&&a>=5.5&&a<7}return GeoGlobe.Util.alphaHackNeeded};GeoGlobe.Util.upperCaseObject=function(a){var b={},c;for(c in a)b[c.toUpperCase()]=a[c];return b};
GeoGlobe.Util.applyDefaults=function(a,b){var a=a||{},c=typeof window.Event=="function"&&b instanceof window.Event,d;for(d in b)if(a[d]===void 0||!c&&b.hasOwnProperty&&b.hasOwnProperty(d)&&!a.hasOwnProperty(d))a[d]=b[d];if(!c&&b&&b.hasOwnProperty&&b.hasOwnProperty("toString")&&!a.hasOwnProperty("toString"))a.toString=b.toString;return a};
...
GeoGlobe.METERS_PER_INCH,Mile:1609.3472186944373/GeoGlobe.METERS_PER_INCH,IYard:0.9144/GeoGlobe.METERS_PER_INCH,IMile:1609.344/GeoGlobe.METERS_PER_INCH,NautM:1852/GeoGlobe.METERS_PER_INCH,"Lat-66":110943.31648893273/GeoGlobe.METERS_PER_INCH,"Lat-83":110946.25736872235/GeoGlobe.METERS_PER_INCH,Decimeter:0.1/GeoGlobe.METERS_PER_INCH,Millimeter:0.0010/GeoGlobe.METERS_PER_INCH,Dekameter:10/GeoGlobe.METERS_PER_INCH,Decameter:10/GeoGlobe.METERS_PER_INCH,Hectometer:100/GeoGlobe.METERS_PER_INCH,GermanMeter:1.0000135965/
...
GeoGlobe.Util.delayFun=function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b);g&&a.apply(e,f)}};
...
GeoGlobe.Map=GeoGlobe.Class(mapboxgl.FreeCRSMap,{container:null,hash:!1,interactive:!0,preserveDrawingBuffer:!1,zoom:0,center:[0,0],minzoom:0,maxzoom:20,pitch3Dzoom:16,is3Dpitching:!0,isAttributionControl:!0,maxBounds:null,isScrollZoom:!0,isBooxZoom:!0,isDragRotate:!0,isDragPan:!0,isKeyboard:!0,isDoubleClickZoom:!0,isTouchZoomRotate:!0,isTrackResize:!0,logoPosition:!0,bearingSnap:0,bearing:0,pitch:0,showTileBoundaries:!1,showCollisionBoxes:!1,repaint:!0,epsg:"EPSG:3857",units:null,initialize:function(a){this.options=
a;if(a.isAttributionControl==!1)a.attributionControl=a.isAttributionControl;if(a.isScrollZoom==!1)a.scrollZoom=a.isScrollZoom;if(a.isBooxZoom==!1)a.boxZoom=a.isBooxZoom;if(a.isDragRotate==!1)a.dragRotate=a.isDragRotate;if(a.isDragPan==!1)a.dragPan=a.isDragPan;if(a.isKeyboard==!1)a.keyboard=a.isKeyboard;if(a.isDoubleClickZoom==!1)a.doubleClickZoom=a.isDoubleClickZoom;if(a.isTouchZoomRotate==!1)a.touchZoomRotate=a.isTouchZoomRotate;if(a.isTrackResize==!1)a.trackResize=a.isTrackResize;if(!a.epsg)a.epsg=
"EPSG:3857";if(!a.units)a.units="degrees";if(!a.isConstrain)a.isConstrain=!1;this.map=new mapboxgl.FreeCRSMap(a);this.map.epsg=a.epsg;this.map.units=a.units;this.map.setIsConstrain(a.isConstrain);this.map.pitch3Dzoom=this.options.pitch3Dzoom?this.options.pitch3Dzoom:16;this.map.setIs3DPZoom(this.options.is3Dpitching);return this.map},setStyle:function(a){this.map.setStyle(a)},getStyle:function(){return this.map.getStyle()},addControl:function(a){this.map.addControl(a)},removeControl:function(a){this.map.removeControl(a)},
getBounds:function(){return this.map.getBounds()},setMaxBounds:function(a){this.map.setMaxBounds(a)},setMaxZoom:function(a){this.map.setMaxZoom(a)},getMaxZoom:function(){return this.map.getMaxZoom()},setMinZoom:function(a){this.map.setMinZoom(a)},getMinZoom:function(){return this.map.getMinZoom()},project:function(a){return this.map.project(a)},unproject:function(a){return this.map.unproject(a)},addSource:function(a,b){this.map.addSource(a,b)},isSourceLoaded:function(a){this.map.isSourceLoaded(a)},
getSource:function(a){return this.map.getSource(a)},removeSource:function(a){this.map.removeSource(a)},addLayer:function(a,b){this.map.addLayer(a,b)},removeLayer:function(a){this.map.removeLayer(a)},getLayer:function(a){return this.map.getLayer(a)},moveLayer:function(a){this.map.moveLayer(a)},setFilter:function(a,b){this.map.setFilter(a,b)},setLayerZoomRange:function(a,b,c){this.map.setLayerZoomRange(a,b,c)},getFilter:function(a){return this.map.getFilter(a)},setPaintProperty:function(a,b,c,d){this.map.setPaintProperty(a,
b,c,d)},getPaintProperty:function(a,b,c){return this.map.getPaintProperty(a,b,c)},setLayoutProperty:function(a,b,c){this.map.setLayoutProperty(a,b,c)},getLayoutProperty:function(a,b){return this.map.getLayoutProperty(a,b)},queryRenderedFeatures:function(a,b){return this.map.queryRenderedFeatures(a,b)},querySourceFeatures:function(){return this.map.getPaintProperty(layer,name,klass)},addClass:function(a,b){this.map.addClass(a,b)},removeClass:function(a,b){this.map.removeClass(a,b)},setClasses:function(a,
b){this.map.setClasses(a,b)},hasClasses:function(a){return this.map.hasClasses(a)},getClasses:function(){return this.map.getClasses()},resize:function(){this.map.resize()},isloaded:function(){return this.map.loaded()},getCenter:function(){return this.map.getCenter()},setCenter:function(a,b){this.map.setCenter(a,b)},getLight:function(){return this.map.getLight()},setLight:function(a){this.map.setLight(a)},remove:function(){this.map.remove()},panBy:function(a,b,c){this.map.panBy(a,b,c)},panTo:function(a,
b,c){this.map.panTo(a,b,c)},getZoom:function(){return this.map.getZoom()},setZoom:function(a,b){this.map.setZoom(a,b)},zoomTo:function(a,b,c){this.map.zoomTo(a,b,c)},ZoomIn:function(a,b){this.map.zoomIn(a,b)},ZoomOut:function(a,b){this.map.zoomOut(a,b)},getBearing:function(){return this.map.getBearing()},setBearing:function(a,b){this.map.setBearing(a,b)},rotateTo:function(a,b,c){this.map.rotateTo(a,b,c)},getPitch:function(){return this.map.getPitch()},setPitch:function(a,b){this.map.setPitch(a,b)},
fitBounds:function(a,b,c){this.map.fitBounds(a,b,c)},resetNorth:function(a,b){this.map.resetNorth(a,b)},snapToNorth:function(a,b){this.map.snapToNorth(a,b)},getContainer:function(){return this.map.getContainer()},getCanvasContainer:function(){return this.map.getCanvasContainer()},getCanvas:function(){return this.map.getCanvas()},jumpTo:function(a,b){this.map.jumpTo(a,b)},easeTo:function(a,b){this.map.easeTo(a,b)},flyTo:function(a,b){this.map.flyTo(a,b)},isMoving:function(){this.map.stop()},stop:function(){this.map.stop()},
SpatialReference:function(){var a=null;if(this.baseLayer!=null)a=this.SpatialReference;return a?a.getCode():null},CLASS_NAME:"GeoGlobe.Map"});mapboxgl.FreeCRSMap.prototype.addCanvasLayer=function(a){a.addTo(this)};mapboxgl.FreeCRSMap.prototype.removeCanvasLayer=function(a){a.remove()};mapboxgl.FreeCRSMap.prototype.setIs3DPZoom=function(a){if(a)this.on("zoom",this.setZoompitch);else this.off("zoom",this.setZoompitch)};mapboxgl.FreeCRSMap.prototype.set3Dzoom=function(a){if(a)this.pitch3Dzoom=a};
mapboxgl.FreeCRSMap.prototype.setZoompitch=function(){var a=this.getZoom(),b=this.pitch3Dzoom,c=this.getPitch();parseInt(a)>=b?c==0&&this.setPitch(60):c==60&&this.setPitch(0)};mapboxgl.FreeCRSMap.prototype.addLayers=function(a){if(a.length>0)for(var b=0;b<a.length;b++)this.addLayer(a[b])};mapboxgl.FreeCRSMap.prototype.getResolutions=function(){for(var a=[],b=0;b<=20;b++)a.push(this.getResolutionForLevel(b));return a};
mapboxgl.FreeCRSMap.prototype.getResolutionForLevel=function(a,b){var c=Math.abs(this._tileExtent[2]-this._tileExtent[0]);return c/(b?b:256)/Math.pow(2,a)};mapboxgl.FreeCRSMap.prototype.setIsConstrain=function(a){this.isConstrain=a;this.transform._constraining=!this.isConstrain};
mapboxgl.FreeCRSMap.prototype.addLayer=function(a,b){if(a.layerOption&&a.layerOption.metadata.type==="wms"&&a.layerOption.metadata.isTile===!1)return a.addTo(this),this.style.addLayer(a.layerOption,b),this._update(!0),this;if(a.layerOption&&a.layerOption.metadata.type==="hotarea")return a.addTo(this),this;if(typeof a.source==="object"&&this._mapCRS&&a.source&&a.source.type=="geojson"&&a.source.data&&!a.source.data.customprj)a.source.data.customprj=this._geojson_customprj;this.style.addLayer(a,b);
this._update(!0);return this};mapboxgl.FreeCRSMap.prototype.removeLayerAndSource=function(a){if(this.getLayer(a))this.removeLayer(a),this.removeSource(a);else throw Error("Layer not found");};
GeoGlobe.LngLatBounds=GeoGlobe.Class(mapboxgl.LngLatBounds,{sw:null,ne:null,initialize:function(a,b){return this.LngLatBounds=new mapboxgl.LngLatBounds(a,b)},convert:function(a){return this.LngLatBounds.convert(a)},setNorthEast:function(a){this.LngLatBounds.setNorthEast(a)},setSouthWest:function(a){this.LngLatBounds.setSouthWest(a)},extend:function(a){this.LngLatBounds.extend(a)},getCenter:function(){return this.LngLatBounds.getCenter()},getSouthWest:function(){return this.LngLatBounds.getSouthWest()},
getNorthEast:function(){return this.LngLatBounds.getNorthEast()},getNorthWest:function(){return this.LngLatBounds.getNorthWest()},getSouthEast:function(){return this.LngLatBounds.getSouthEast()},getWest:function(){return this.LngLat.getWest()},getEast:function(){return this.LngLatBounds.getEast()},getSouth:function(){return this.LngLatBounds.getSouth()},getNorth:function(){return this.LngLatBounds.getNorth()},toArray:function(){return this.LngLatBounds.toArray()},toString:function(){return this.LngLat.toString()},
equals:function(){},getWidth:function(){},containsLonLat:function(){},contains:function(){},clone:function(){},toBBOX:function(){},toGeometry:function(){},getCenterLonLat:function(){},CLASS_NAME:"GeoGlobe.LngLatBounds"});mapboxgl.LngLatBounds.prototype.clone=function(){return new mapboxgl.LngLatBounds(this._sw,this._ne)};
...
GeoGlobe.LngLatBounds.toGeometryByTwoPixel=function(a,b,c){for(var a=[mapboxgl.Point.convert(a),mapboxgl.Point.convert(b)],a=[a[0],new mapboxgl.Point(a[1].x,a[0].y),a[1],new mapboxgl.Point(a[0].x,a[1].y)],b=[],d=0;d<a.length;d++){var e=c.unproject(a[d]),e=new GeoGlobe.Geometry.Point(e.lng,e.lat);b.push(e)}return new GeoGlobe.Geometry.Polygon([new GeoGlobe.Geometry.LinearRing(b)])};
GeoGlobe.LngLat=GeoGlobe.Class(mapboxgl.LngLat,{lon:null,lat:null,initialize:function(a,b){return this.LngLat=new mapboxgl.LngLat(a,b)},convert:function(a){return this.LngLat.convert(a)},wrap:function(){return this.LngLat.wrap()},toArray:function(){return this.LngLat.toArray()},toString:function(){return this.LngLat.toString()},CLASS_NAME:"GeoGlobe.LngLat"});
GeoGlobe.Layer=GeoGlobe.Class(mapboxgl.FreeCRSMap,{visibility:null,id:null,name:null,alias:null,ref:null,sourceId:null,sourceLayerId:null,metadata:null,filter:null,maxZoom:20,minZoom:0,initialize:function(){return this},CLASS_NAME:"GeoGlobe.Layer"});
GeoGlobe.Layer.WMTS=GeoGlobe.Class4OL({url:null,layer:null,format:null,matrixSet:null,style:null,name:null,resolutions:null,zoomOffset:null,matrixIds:null,tileOrigin:null,tileFullExtent:null,initialize:function(a){return this._getWMTSLayer(a)},_getWMTSLayer:function(a){var b={};if(a.layer)b.LAYER=a.layer;if(a.format)b.FORMAT=a.format;if(a.matrixSet)b.TILEMATRIXSET=a.matrixSet;if(a.version)b.VERSION=a.version;if(a.style)b.STYLE=a.style;b.TILEMATRIX="{z}";b.TILEROW="{y}";b.TILECOL="{x}";GeoGlobe.Util.applyDefaults(b,
{service:"WMTS",request:"GetTile"});b=GeoGlobe.ProxyHost+this.urlAppend(a.url,this.getParameterString(b||{}));return{id:"wmts_"+a.layer+"_"+GeoGlobe.Util.randomStr(8),type:"raster",source:{type:"raster",tiles:[b],tileSize:256}}},getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];if(d!=null&&typeof d!="function"){if(typeof d=="object"&&d.constructor==Array){for(var e=[],f,g=0,h=d.length;g<h;g++)f=d[g],e.push(encodeURIComponent(f===null||f===void 0?"":f));d=e.join(",")}b.push(encodeURIComponent(c)+
"="+d)}}return b.join("&")},urlAppend:function(a,b){var c=a;if(b){var d=(a+" ").split(/[?&]/);c+=d.pop()===" "?b:d.length?"&"+b:"?"+b}return c},clone:function(a){a==null&&(a=new GeoGlobe.Layer.WMTS(this.id,this.tileSize,this.filter,this.opacity,this.visible,this.name,this.url));return a},getMatrix:function(){var a;if(!this.matrixIds||this.matrixIds.length===0)a={identifier:this.getIdentifier()};else if("scaleDenominator"in this.matrixIds[0])for(var b=GeoGlobe.METERS_PER_INCH*GeoGlobe.INCHES_PER_UNIT[this.units]*
this.getServerResolution()/2.8E-4,c=Number.POSITIVE_INFINITY,d,e=0,f=this.matrixIds.length;e<f;++e)d=Math.abs(1-this.matrixIds[e].scaleDenominator/b),d<c&&(c=d,a=this.matrixIds[e]);else a=this.matrixIds[this.getIdentifier()];return a},CLASS_NAME:"GeoGlobe.Layer.WMTS"});
...
!1?a.transparent:!0;if(a.styles)b.styles=a.styles;if(a.tileSize)b.HEIGHT=a.tileSize,b.WIDTH=a.tileSize;if(a.version)b.VERSION=a.version;if(a.SRS)b.SRS=a.SRS;b.BBOX="{bbox-epsg-3857}";GeoGlobe.Util.applyDefaults(b,{service:"WMS",request:"GetMap"});var c={name:a.layer,srs:a.SRS,bbox:a.bbox,format:a.format},d="wms_"+a.layer+"_"+GeoGlobe.Util.randomStr(8),b=this.urlAppend(a.url,this.getParameterString(b||{})),b=GeoGlobe.appendToProxy(b);return{id:d,type:"raster",source:{type:"raster",tiles:[b],tileSize:a.tileSize},
metadata:c}},moveend:function(){if(this.map.style._layers[this.id]&&this.map.style._layers[this.id].layout.visibility!="none"){var a=this.map.getBounds(),b=a._ne.lng,c=a._ne.lat,d=a._sw.lng,e=a._sw.lat,a,f=this.getParameterString({SERVICE:"WMS",REQUEST:"GetMap",VERSION:this.options.version,LAYERS:this.options.layer,styles:this.options.styles,FORMAT:this.options.format,TRANSPARENT:this.options.transparent,BBOX:d+","+e+","+b+","+c,WIDTH:this.width,HEIGHT:this.height,SRS:this.options.SRS});a="";a=this.url.endsWith("?")?
this.url+f:this.url+"?"+f;a=GeoGlobe.appendToProxy(a);b=[[d,c],[b,c],[b,e],[d,e]];c=this.map.getSource(this.id);c.url=a;c.options.url=a;c.coordinates=b;c.options.coordinates=b;c.load()}},getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];if(d!=null&&typeof d!="function"){if(typeof d=="object"&&d.constructor==Array){for(var e=[],f,g=0,h=d.length;g<h;g++)f=d[g],e.push(encodeURIComponent(f===null||f===void 0?"":f));d=e.join(",")}b.push(encodeURIComponent(c)+"="+d)}}return b.join("&")},
urlAppend:function(a,b){var c=a;if(b){var d=(a+" ").split(/[?&]/);c+=d.pop()===" "?b:d.length?"&"+b:"?"+b}return c},clone:function(a){a==null&&(a=new GeoGlobe.Layer.WMS(this.id,this.tileSize,this.filter,this.opacity,this.visible,this.name,this.url));return a},getParamString:function(a){var b=[],c;for(c in a){var d=a[c];d!=null&&typeof d!="function"&&b.push(c+"="+d)}return b.join("&")},CLASS_NAME:"GeoGlobe.Layer.WMS"});
GeoGlobe.Layer.VTS=GeoGlobe.Class4OL({url:null,layer:null,format:null,matrixSet:null,style:null,name:null,resolutions:null,zoomOffset:null,matrixIds:null,tileOrigin:null,tileFullExtent:null,initialize:function(a){return this._getVTSLayer(a)},_getVTSLayer:function(a){this.url=a.url;var b={};if(a.layer)b.LAYER=a.layer;if(a.format)b.FORMAT=a.format;if(a.matrixSet)b.TILEMATRIXSET=a.matrixSet;if(a.version)b.VERSION=a.version;if(a.tileSize)b.WIDTH=a.tileSize,b.HEIGHT=a.tileSize;b.TILEMATRIX="{z}";b.TILEROW=
"{y}";b.TILECOL="{x}";GeoGlobe.Util.applyDefaults(b,{service:"WMTS",request:"GetTile"});var c=GeoGlobe.ProxyHost+this.urlAppend(a.url,this.getParameterString(b||{})),d=[];this.GetStyle(a.styleName,function(a){var b={sprite:a.sprite?GeoGlobe.ProxyHost+a.sprite:"",glyphs:a.glyphs?GeoGlobe.ProxyHost+a.glyphs:"",styleName:a.styleName};if(a.styleData)for(var g=0;g<a.styleData.layers.length;g++)a.styleData.layers[g].metadata=b,a.styleData.layers[g].source={type:"vector",tiles:[c]},d[g]=a.styleData.layers[g];
else for(g=0;g<a.layers.length;g++)a.layers[g].source={type:"vector",tiles:[c]},a.layers[g].metadata=b,d[g]=a.layers[g]},function(){alert("WMTS\u670d\u52a1\u8bf7\u6c42\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u670d\u52a1\u662f\u5426\u6b63\u5e38\u8fd0\u884c\u6216\u8bf7\u6c42\u5730\u5740\u662f\u5426\u6b63\u786e\u3002\n\u8bf7\u6c42\u5730\u5740\uff1a"+c+"\n\u64cd\u4f5c\u7c7b\u578b\uff1aGetCapabilities")});return d},getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];if(d!=null&&typeof d!="function"){if(typeof d==
"object"&&d.constructor==Array){for(var e=[],f,g=0,h=d.length;g<h;g++)f=d[g],e.push(encodeURIComponent(f===null||f===void 0?"":f));d=e.join(",")}b.push(encodeURIComponent(c)+"="+d)}}return b.join("&")},urlAppend:function(a,b){var c=a;if(b){var d=(a+" ").split(/[?&]/);c+=d.pop()===" "?b:d.length?"&"+b:"?"+b}return c},GetStyle:function(a,b,c){var d=this.url;if(a==""||a==void 0)alert("\u8bf7\u67e5\u770b\u6837\u5f0f\u540d\u79f0\u662f\u5426\u5b58\u5728");else{var e={REQUEST:"GetStyle",SERVICE:"WMTS",VERSION:"1.0.0",
STYLENAME:a};c||(c=function(){this.failFn(e.REQUEST)});GeoGlobe.Request.GET({url:d,params:e,scope:this,async:!1,success:function(a){a=a.responseText;if(!a)return c(),!1;a=(new GeoGlobe.Format.JSON).read(a);b(a)},failure:c})}},clone:function(a){a==null&&(a=new GeoGlobe.Layer.VTS(this.id,this.tileSize,this.filter,this.opacity,this.visible,this.name,this.url));return a},getMatrix:function(){var a;if(!this.matrixIds||this.matrixIds.length===0)a={identifier:this.getIdentifier()};else if("scaleDenominator"in
this.matrixIds[0])for(var b=GeoGlobe.METERS_PER_INCH*GeoGlobe.INCHES_PER_UNIT[this.units]*this.getServerResolution()/2.8E-4,c=Number.POSITIVE_INFINITY,d,e=0,f=this.matrixIds.length;e<f;++e)d=Math.abs(1-this.matrixIds[e].scaleDenominator/b),d<c&&(c=d,a=this.matrixIds[e]);else a=this.matrixIds[this.getIdentifier()];return a},CLASS_NAME:"GeoGlobe.Layer.VTS"});
...
GeoGlobe.Layer.RasterLayer=GeoGlobe.Class(GeoGlobe.Layer,{"raster-opacity":null,"raster-hue-rotate":null,"raster-brightness-min":null,"raster-brightness-max":null,"raster-saturation":null,"raster-contrast":null,"raster-fade-duration":null,initialize:function(a){return a},CLASS_NAME:"GeoGlobe.Layer.RasterLayer"});
GeoGlobe.Layer.FillLayer=GeoGlobe.Class(GeoGlobe.Layer,{"fill-color":null,"fill-pattern":null,"fill-opacity":null,"fill-antialias":null,"fill-outline-color":null,"fill-translate":null,"fill-translate-anchor":null,initialize:function(a){return a},CLASS_NAME:"GeoGlobe.Layer.FillLayer"});
GeoGlobe.Layer.CircleLayer=GeoGlobe.Class(GeoGlobe.Layer,{"circle-radius":null,"circle-color":null,"circle-blur":null,"circle-opacity":null,"circle-pitch-scale":null,"circle-translate":null,"circle-translate-anchor":null,initialize:function(a){return a},CLASS_NAME:"GeoGlobe.Layer.CircleLayer"});
GeoGlobe.Layer.SymbolLayer=GeoGlobe.Class(GeoGlobe.Layer,{visibility:null,"symbol-placement":null,"symbol-spacing":null,"symbol-avoid-edges":null,"icon-allow-overlap ":null,"icon-ignore-placement":null,"icon-optional":null,"icon-rotation-alignment":null,"icon-size":null,"icon-text-fit":null,"icon-text-fit-padding":null,"icon-image":null,"icon-rotate":null,"icon-padding":null,"icon-offset":null,"icon-keep-upright":null,"text-pitch-alignment":null,"text-rotate-alignment":null,"text-field":null,"text-font":null,
"text-size":null,"text-max-width":null,"text-line-height":null,"text-letter-spacing":null,"text-justify":null,"text-anchor":null,"text-max-angle":null,"text-rotate":null,"text-padding":null,"text-keep-upright":null,"text-offset":null,"text-transform":null,"text-allow-overlap ":null,"text-ignore-placement":null,"text-optional":null,"icon-color":null,"icon-halo-color":null,"icon-opacity":null,"icon-halo-width":null,"icon-halo-blur":null,"icon-translate ":null,"icon-translate-anchor":null,"text-color":null,
"text-halo-color":null,"text-opacity":null,"text-halo-width":null,"text-halo-blur":null,"text-translate ":null,"text-translate-anchor":null,initialize:function(a){return a},CLASS_NAME:"GeoGlobe.Layer.SymbolLayer"});
GeoGlobe.Layer.FillExtrusionLayer=GeoGlobe.Class(GeoGlobe.Layer,{"fill-extrusion-height":null,"fill-extrusion-pattern":null,"fill-extrusion-color":null,"fill-extrusion-base":null,"fill-extrusion-opacity":null,"fill-extrusion-translate":null,"fill-extrusion-translate-anchor":null,initialize:function(a){return a},CLASS_NAME:"GeoGlobe.Layer.FillExtrusionLayer"});
GeoGlobe.Layer.LineLayer=GeoGlobe.Class(GeoGlobe.Layer,{"line-color":null,"line-pattern":null,"line-opacity":null,"line-translate":null,"line-translate-anchor":null,"line-cap":null,"line-join":null,"line-miter-limit":null,"line-round-limit":null,"line-width":null,"line-gap-width":null,"line-offset":null,"line-blur":null,"line-dasharray":null,initialize:function(a){return a},CLASS_NAME:"GeoGlobe.Layer.LineLayer"});
GeoGlobe.Layer.BackgroundLayer=GeoGlobe.Class(GeoGlobe.Layer,{"background-color":null,"background-pattern":null,"background-opacity":null,initialize:function(a){return a},CLASS_NAME:"GeoGlobe.Layer.BackgroundLayer"});
...
"none"){var a=this.map.style._layers[this.options.id].metadata,b=this.map.style._layers[this.options.id].paint;this.map.removeLayer(this.options.id);this.map.removeSource(this.options.id);box=this.map.getBounds();var c=this.options.params;maxx=box._ne.lng;maxy=box._ne.lat;minx=box._sw.lng;miny=box._sw.lat;c=this.seturl(c);url=this.options.url+"/map/"+this.options.layerID+"/"+this.options.chartID+"/"+minx+"/"+miny+"/"+maxx+"/"+maxy+"/"+this.options.width+"/"+this.options.height+".png?"+c;layer={id:this.options.id,
source:{type:"image",url:url,coordinates:[[minx,maxy],[maxx,maxy],[maxx,miny],[minx,miny]]},type:"raster"};layer.paint=b;layer.metadata=a;this.map.addLayer(layer)}},dragend:function(){if(this.map.style._layers[this.options.id]&&this.map.style._layers[this.options.id].layout.visibility!="none"){var a=this.map.style._layers[this.options.id].metadata,b=this.map.style._layers[this.options.id].paint;this.map.removeLayer(this.options.id);this.map.removeSource(this.options.id);box=this.map.getBounds();var c=
this.options.params;maxx=box._ne.lng;maxy=box._ne.lat;minx=box._sw.lng;miny=box._sw.lat;c=this.seturl(c);url=this.options.url+"/map/"+this.options.layerID+"/"+this.options.chartID+"/"+minx+"/"+miny+"/"+maxx+"/"+maxy+"/"+this.options.width+"/"+this.options.height+".png?"+c;layer={id:this.options.id,source:{type:"image",url:url,coordinates:[[minx,maxy],[maxx,maxy],[maxx,miny],[minx,miny]]},type:"raster"};layer.paint=b;layer.metadata=a;this.map.addLayer(layer)}},seturl:function(a){var b="",c;for(c in a)a[c]!=
-1&&(b+=c+"="+a[c]+"&");return b=b.substring(0,b.length-1)},getCapabilities:function(a,b,c){typeof c!="function"&&(c=function(){alert("\u4e13\u9898\u56fe\u670d\u52a1\u8bf7\u6c42\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u670d\u52a1\u662f\u5426\u6b63\u5e38\u8fd0\u884c\u6216\u8bf7\u6c42\u5730\u5740\u662f\u5426\u6b63\u786e\u3002\n\u8bf7\u6c42\u5730\u5740\uff1a"+a+"\n\u64cd\u4f5c\u7c7b\u578b\uff1aGetCapabilities")});$.ajax({url:a,dataType:"json",cache:!1,async:!1,success:function(a){typeof b=="function"&&b(a)},
failure:c})},remove:function(a){this.map.off("zoomend",this.zoome);this.map.off("dragend",this.drage);this.map.removeLayer(a);this.map.removeSource(a)},showLegend:function(){var a=this.getLegend({layerID:this.layerID,chartID:this.chartID,colorSchemeID:this.colorSchemeID,drawLegend:"ThematicMap",legendType:this.legendType});this.imageLegend||(new GeoGlobe.Marker(a)).setLngLat([lnglat.lng,lnglat.lat]).addTo(this.map)},getLegend:function(a){if(this.url.indexOf("/",this.url.length-1)!=-1)this.url=this.url.substr(0,
this.url.length-1);var b;b=Geo.String.format("${url}/legend/${layerID}/${chartID}.${format}?drawLegend=${drawLegend}&legendType=${legendType}",{url:this.url,layerID:a.layerID,chartID:a.chartID,format:a.format||"png",drawLegend:a.drawLegend,legendType:a.legendType});typeof a.colorSchemeID==="string"&&(b+="&ColorSchemeID="+a.colorSchemeID);return b},setLegendLocation:function(a){var b=this.map.getSize();switch(this.legendPosition){case "br":var c=b.w-this.legendSize.w,b=b.h-this.legendSize.h;a.style.left=
c+"px";a.style.top=b+"px";break;case "bl":b=b.h-this.legendSize.h;a.style.left="0px";a.style.top=b+"px";break;case "tl":a.style.left="0px";a.style.top="0px";break;case "tr":c=b.w-this.legendSize.w,a.style.left=c+"px",a.style.top="0px"}},showBaseMapLegend:function(){var a=this.getBaseMapLegend({layerID:this.layerID,chartID:this.chartID,drawLegend:"BaseMap",baseMapExampleColumnNums:this.baseMapExampleColumnNums});this.imageBaseMapLegend||(new GeoGlobe.Marker(a)).setLngLat([lnglat.lng,lnglat.lat]).addTo(this.map)},
getBaseMapLegend:function(a){if(this.url.indexOf("/",this.url.length-1)!=-1)this.url=this.url.substr(0,this.url.length-1);return a=Geo.String.format("${url}/legend/${layerID}/${chartID}.${format}?drawLegend=${drawLegend}&baseMapExampleColumnNums=${baseMapExampleColumnNums}",{url:this.url,layerID:a.layerID,chartID:a.chartID,format:a.format||"png",drawLegend:a.drawLegend,baseMapExampleColumnNums:a.baseMapExampleColumnNums})},setBaseMapLegendLocation:function(a){var b=this.map.getSize();switch(this.baseMapLegendPosition){case "br":var c=
b.w-this.baseMapLegendSize.w,b=b.h-this.baseMapLegendSize.h;a.style.left=c+"px";a.style.top=b+"px";break;case "bl":b=b.h-this.baseMapLegendSize.h;a.style.left="0px";a.style.top=b+"px";break;case "tl":a.style.left="50px";a.style.top="0px";break;case "tr":c=b.w-this.baseMapLegendSize.w,a.style.left=c+"px",a.style.top="0px"}},updateHotArea:function(a){a.zoomChanged?this.vectorLayer.removeAllFeatures():this.vectorLayer.redraw()},clone:function(a){a==null&&(a=new GeoGlobe.Layer.ThematicTileLayer(this.id,
this.url,this.params,this.getOptions()));return a},getURL:function(a){var a=this.adjustBounds(a),b=this.getImageSize(),a=GeoGlobe.String.format("${url}/map/${layerID}/${chartID}/${left}/${bottom}/${right}/${top}/${width}/${height}.${format}?hasLegend=${hasLegend}&legendType=${legendType}&hasEdge=${hasEdge}&hasLabel=${hasLabel}&hasBaseMap=${hasBaseMap}&hasBaseMapLegend=${hasBaseMapLegend}&baseMapExampleColumnNums=${baseMapExampleColumnNums}",{url:this.url,layerID:this.layerID,chartID:this.chartID,
...
[],c;for(c in a){var d=a[c];d!=null&&typeof d!="function"&&b.push(c.toUpperCase()+"="+d)}return b.join("&")},onclick:function(){},CLASS_NAME:"GeoGlobe.Layer.HotArea"});GeoGlobe.Source=GeoGlobe.Class(mapboxgl.FreeCRSMap,{SourceId:null,initialize:function(){return this},CLASS_NAME:"GeoGlobe.Source"});
GeoGlobe.Source.GeoJSONSource=GeoGlobe.Class(mapboxgl.FreeCRSMap,{minzoom:null,maxzoom:null,data:null,buffer:null,tolerance:null,cluster:null,clusterRadius:null,clusterMaxZoom:null,initialize:function(a,b){var c={};c.id=a;c.source=b;return c},CLASS_NAME:"GeoGlobe.Source.GeoJSONSource"});GeoGlobe.Source.RasterSource=GeoGlobe.Class(mapboxgl.FreeCRSMap,{minzoom:null,maxzoom:null,tilesUrl:null,url:null,tileSize:null,initialize:function(a){return{id:a.id,type:"raster",tiles:a.url,tileSize:256}},CLASS_NAME:"GeoGlobe.Source.RasterSource"});
GeoGlobe.Source.ImageSource=GeoGlobe.Class(mapboxgl.FreeCRSMap,{coordinates:null,url:null,initialize:function(a,b){var c={};c.id=a;c.source=b;return c},CLASS_NAME:"GeoGlobe.Source.ImageSource"});GeoGlobe.Source.VectorSource=GeoGlobe.Class(mapboxgl.FreeCRSMap,{minzoom:null,maxzoom:null,tilesUrl:null,url:null,initialize:function(a){return{id:a.id,type:a.type,tiles:a.url}},CLASS_NAME:"GeoGlobe.Source.VectorSource"});
GeoGlobe.Source.VideoSource=GeoGlobe.Class(mapboxgl.FreeCRSMap,{coordinates:null,url:null,initialize:function(a,b){var c={};c.id=a;c.video=b;return c},CLASS_NAME:"GeoGlobe.Source.VideoSource"});
GeoGlobe.Marker=GeoGlobe.Class(mapboxgl.Marker,{offset:null,initialize:function(a,b){return this.Marker=new mapboxgl.Marker(a,b)},addTo:function(a){this.Marker.addTo(a)},remove:function(){this.Marker.remove()},getLngLat:function(){return this.Marker.getLngLat()},setLngLat:function(a){this.Marker.setLngLat(a)},setPopup:function(a){this.Marker.setPopup([a])},getPopup:function(){this.Marker.getPopup()},togglePopup:function(){this.Marker.togglePopup()},CLASS_NAME:"GeoGlobe.Marker"});
GeoGlobe.Popup=GeoGlobe.Class(mapboxgl.Popup,{closeButton:!0,closeOnClick:!0,anchor:null,offset:null,showArrow:!0,initialize:function(a){return this.Popup=new mapboxgl.Popup(a)},addTo:function(a){this.Popup.addTo(a)},isOpen:function(){return this.Popup.isOpen()},remove:function(){this.Popup.remove()},getLngLat:function(){return this.Popup.getLngLat()},setLngLat:function(a){this.Popup.setLngLat(a)},setText:function(a){this.Popup.setText(a)},setHTML:function(a){this.Popup.setHTML(a)},setDOMContent:function(a){this.Popup.setDOMContent(a)},
CLASS_NAME:"GeoGlobe.Popup"});GeoGlobe.Control=GeoGlobe.Class(mapboxgl.Control,{position:null,initialize:function(a){return this.control=new mapboxgl.Control(a)},addTo:function(a){this.control.addTo(a)},remove:function(){this.control.remove()},CLASS_NAME:"GeoGlobe.Control"});GeoGlobe.Control.Navigation=GeoGlobe.Class(GeoGlobe.Control,{position:null,initialize:function(){return this.control=new mapboxgl.NavigationControl},CLASS_NAME:"GeoGlobe.Control.Navigation"});
GeoGlobe.Control.Attribution=GeoGlobe.Class(GeoGlobe.Control,{position:null,initialize:function(a){return this.control=new mapboxgl.AttributionControl({position:a.position,map_attr:a.map_attr})},CLASS_NAME:"GeoGlobe.Control.Attribution"});
...
"m")c=b.lng-a.lng;else var c=Math.PI/180,d=a.lat*c,e=b.lat*c,c=6371E3*Math.acos(Math.min(Math.sin(d)*Math.sin(e)+Math.cos(d)*Math.cos(e)*Math.cos((b.lng-a.lng)*c),1));return c},_getRoundNum:function(a){var b=Math.pow(10,(""+Math.floor(a)).length-1);a/=b;return b*(a>=10?10:a>=5?5:a>=3?3:a>=2?2:1)},CLASS_NAME:"GeoGlobe.Control.Scale"});
GeoGlobe.Control.Geolocate=GeoGlobe.Class(GeoGlobe.Control,{position:null,initialize:function(a){return this.control=new mapboxgl.GeolocateControl({position:a.position,point:a.point})},CLASS_NAME:"GeoGlobe.Control.Geolocate"});
...
GeoGlobe.Event=GeoGlobe.Class(mapboxgl.Evented,{initialize:function(){return this.Event=mapboxgl.Evented},CLASS_NAME:"GeoGlobe.Event"});
GeoGlobe.Event.MapMouseEvent=GeoGlobe.Class(GeoGlobe.Event,{target:null,initialize:function(a){this.el=a.getCanvasContainer();this.map=a;var b=new GeoGlobe.Popup({closeButton:!1,closeOnClick:!1});this.el.addEventListener("mouseout",this.onMouseOut,!1);this.el.addEventListener("mousedown",this.onMouseDown,!1);this.el.addEventListener("mouseup",this.onMouseUp,!1);this.el.addEventListener("mousemove",this.onMouseMove,!1);this.el.addEventListener("click",this.sigleClick,!1);this.el.addEventListener("dblclick",
this.doubleClick,!1);this.el.addEventListener("contextmenu",this.onContextMenu,!1);this.onMouseOut=function(){a.on("mouseout",function(){alert("out")})};this.onMouseDown=function(){a.stop();a.on("mousedown",function(){alert("down")})};this.onMouseUp=function(){a.dragRotate&&a.dragRotate.isActive();a.on("mouseup",function(){alert("up")})};this.onMouseMove=function(){if(!a.dragPan||!a.dragPan.isActive())if(!a.dragRotate||!a.dragRotate.isActive())a.on("mousemove",function(c){var d=JSON.stringify(c.point)+
"<br />"+JSON.stringify(c.lngLat);b.setLngLat([c.lngLat.lng,c.lngLat.lat]).setHTML(d).addTo(a)})};this.sigleClick=function(){a.on("click",function(){alert("sigle")})};this.doubleClick=function(){a.on("dblclick",function(){alert("double")})};this.onContextMenu=function(a){a.preventDefault()};this.remove=function(a){switch(a){case "mouseout":this.el.removeEventListener("mouseout",this.onMouseMove);this.map._listeners.mouseout.splice(0,1);break;case "mousemove":this.el.removeEventListener("mousemove",
this.onMouseMove);b.remove();this.map._listeners.mousemove.splice(0,1);break;case "mousedown":this.el.removeEventListener("mousedown",this.onMouseDown);this.map._listeners.mousedown.splice(0,1);break;case "mouseup":this.el.removeEventListener("mouseup",this.onMouseUp);this.map._listeners.mouseup.splice(0,1);break;case "dblclick":this.el.removeEventListener("dblclick",this.doubleClick);this.map._listeners.dblclick.splice(0,1);break;case "click":this.el.removeEventListener("click",this.sigleClick),
this.map._listeners.click.splice(0,1)}};return this},onMouseOut:function(){},onMouseDown:function(){},onMouseUp:function(){},onMouseMove:function(){},sigleClick:function(){},doubleClick:function(){map.on("dblclick",function(){alert("double")})},onContextMenu:function(a){contextMenuEvent=a;a.preventDefault()},remove:function(a){switch(a){case "mouseout":this.el.removeEventListener("mouseout",this.onMouseMove);this.map._listeners.mouseout.splice(0,1);break;case "mousemove":this.el.removeEventListener("mousemove",
this.onMouseMove);popup.remove();this.map._listeners.mousemove.splice(0,1);break;case "mousedown":this.el.removeEventListener("mousedown",this.onMouseDown);this.map._listeners.mousedown.splice(0,1);break;case "mouseup":this.el.removeEventListener("mouseup",this.onMouseUp);this.map._listeners.mouseup.splice(0,1);break;case "dblclick":this.el.removeEventListener("dblclick",this.doubleClick);this.map._listeners.dblclick.splice(0,1);break;case "click":this.el.removeEventListener("click",this.sigleClick),
this.map._listeners.click.splice(0,1)}},CLASS_NAME:"GeoGlobe.Event.MapMouseEvent"});
GeoGlobe.Event.MapTouchEvent=GeoGlobe.Class(GeoGlobe.Event,{target:null,initialize:function(a){this.el=a.getCanvasContainer();this.map=a;var b=null;this.el.addEventListener("touchstart",this.onTouchStart,!1);this.el.addEventListener("touchend",this.onTouchEnd,!1);this.el.addEventListener("touchmove",this.onTouchMove,!1);this.el.addEventListener("touchcancel",this.onTouchCancel,!1);this.el.addEventListener("dblclick",this.doubleClick,!1);this.onTouchStart=function(){a.stop();alert("xxfds");a.on("touchstart",
function(){alert("double1")});b?(clearTimeout(b),b=null,a.on("dblclick",function(){alert("double2")})):b=setTimeout(this.onTouchTimeout,300)};this.onTouchMove=function(){alert("xcsx");a.on("touchmove",function(){alert("double3")})};this.onTouchEnd=function(){alert("xfx");a.on("touchend",function(){alert("double4")})};this.onTouchCancel=function(){alert("xx");a.on("touchcancel",function(){alert("double5")})};this.onTouchTimeout=function(){b=null};this.doubleClick=function(b){a.on(b,function(){alert("double")})};
this.remove=function(a){switch(a){case "touchstart":this.el.removeEventListener("touchstart",this.onMouseMove);this.map._listeners.touchstart.splice(0,1);break;case "touchmove":this.el.removeEventListener("touchmove",this.onMouseMove);popup.remove();this.map._listeners.touchmove.splice(0,1);break;case "touchend":this.el.removeEventListener("touchend",this.onMouseDown);this.map._listeners.touchend.splice(0,1);break;case "touchcancel":this.el.removeEventListener("touchcancel",this.onMouseUp);this.map._listeners.touchcancel.splice(0,
1);break;case "dblclick":this.el.removeEventListener("dblclick",this.touchcancel),this.map._listeners.dblclick.splice(0,1)}};return this},onTouchStart:function(){map.stop();alert("xxfds");map.on("touchstart",function(){alert("double1")});tapped?(clearTimeout(tapped),tapped=null,map.on("dblclick",function(){alert("double2")})):tapped=setTimeout(this.onTouchTimeout,300)},onTouchMove:function(){alert("xcsx");map.on("touchmove",function(){alert("double3")})},onTouchEnd:function(){alert("xfx");map.on("touchend",
function(){alert("double4")})},onTouchCancel:function(){alert("xx");map.on("touchcancel",function(){alert("double5")})},onTouchTimeout:function(){tapped=null},remove:function(a){switch(a){case "touchstart":this.el.removeEventListener("touchstart",this.onMouseMove);this.map._listeners.touchstart.splice(0,1);break;case "touchmove":this.el.removeEventListener("touchmove",this.onMouseMove);popup.remove();this.map._listeners.touchmove.splice(0,1);break;case "touchend":this.el.removeEventListener("touchend",
this.onMouseDown);this.map._listeners.touchend.splice(0,1);break;case "touchcancel":this.el.removeEventListener("touchcancel",this.onMouseUp);this.map._listeners.touchcancel.splice(0,1);break;case "dblclick":this.el.removeEventListener("dblclick",this.touchcancel),this.map._listeners.dblclick.splice(0,1)}},CLASS_NAME:"GeoGlobe.Event.MapTouchEvent"});GeoGlobe.Event.mapDataEvent=GeoGlobe.Class(GeoGlobe.Event,{type:null,datatype:null,initialize:function(){return this},CLASS_NAME:"GeoGlobe.Event.mapDataEvent"});
GeoGlobe.Event.mapBoxZoomEvent=GeoGlobe.Class(GeoGlobe.Event,{target:null,boxZoomBounds:null,initialize:function(a){this.el=a.getCanvasContainer();this.map=a;var b=new GeoGlobe.Popup({closeButton:!1,closeOnClick:!1});this.el.addEventListener("keydown",this.onKeyDown,!1);this.el.addEventListener("mousedown",this.onMouseDown,!1);this.el.addEventListener("mouseup",this.onMouseUp,!1);this.el.addEventListener("mousemove",this.onMouseMove,!1);this.onKeyDown=function(){a.on("keydown",function(){alert("keydown")})};
this.onMouseDown=function(){a.stop();a.on("mousedown",function(a){alert("down");GeoGlobe.DOM.mousePos(this.el,a)})};this.onMouseUp=function(){a.dragRotate&&a.dragRotate.isActive();a.on("mouseup",function(){alert("up")})};this.onMouseMove=function(){if(!a.dragPan||!a.dragPan.isActive())if(!a.dragRotate||!a.dragRotate.isActive())a.on("mousemove",function(c){var d=JSON.stringify(c.point)+"<br />"+JSON.stringify(c.lngLat);b.setLngLat([c.lngLat.lng,c.lngLat.lat]).setHTML(d).addTo(a)})};this.remove=function(a){switch(a){case "mouseout":this.el.removeEventListener("mouseout",
this.onMouseMove);this.map._listeners.mouseout.splice(0,1);break;case "mousemove":this.el.removeEventListener("mousemove",this.onMouseMove);b.remove();this.map._listeners.mousemove.splice(0,1);break;case "mousedown":this.el.removeEventListener("mousedown",this.onMouseDown);this.map._listeners.mousedown.splice(0,1);break;case "mouseup":this.el.removeEventListener("mouseup",this.onMouseUp);this.map._listeners.mouseup.splice(0,1);break;case "dblclick":this.el.removeEventListener("dblclick",this.doubleClick);
this.map._listeners.dblclick.splice(0,1);break;case "click":this.el.removeEventListener("click",this.sigleClick),this.map._listeners.click.splice(0,1)}};return this},onKeyDown:function(){map.on("keydown",function(){alert("keydown")})},onMouseDown:function(){map.stop();map.on("mousedown",function(a){alert("down");startPos=GeoGlobe.DOM.mousePos(this.el,a)})},onMouseUp:function(){map.dragRotate&&map.dragRotate.isActive();map.on("mouseup",function(){alert("up")})},onMouseMove:function(){if(!map.dragPan||
!map.dragPan.isActive())if(!map.dragRotate||!map.dragRotate.isActive())map.on("mousemove",function(a){var b=JSON.stringify(a.point)+"<br />"+JSON.stringify(a.lngLat);popup.setLngLat([a.lngLat.lng,a.lngLat.lat]).setHTML(b).addTo(map)})},remove:function(a){switch(a){case "keydown":this.el.removeEventListener("keydown",this.onKeyDown);this.map._listeners.keydown.splice(0,1);break;case "mousemove":this.el.removeEventListener("mousemove",this.onMouseMove);popup.remove();this.map._listeners.mousemove.splice(0,
1);break;case "mousedown":this.el.removeEventListener("mousedown",this.onMouseDown);this.map._listeners.mousedown.splice(0,1);break;case "mouseup":this.el.removeEventListener("mouseup",this.onMouseUp),this.map._listeners.mouseup.splice(0,1)}},CLASS_NAME:"GeoGlobe.Event.mapBoxZoomEvent"});GeoGlobe.Handler=GeoGlobe.Class({initialize:function(){return this},CLASS_NAME:"GeoGlobe.Handler"});
GeoGlobe.Handler.BoxZoomHandler=GeoGlobe.Class(GeoGlobe.Handler,{map:null,initialize:function(a){return this.handler=a.boxZoom},isActivate:function(){return this.handler.isActive()},isEnabled:function(){return this.handler.isEnabled()},enable:function(){this.handler.enable()},disable:function(){this.handler.disable()},CLASS_NAME:"GeoGlobe.Handler.BoxZoomHandler"});
GeoGlobe.Handler.DoubleClickZoomHandler=GeoGlobe.Class(GeoGlobe.Handler,{map:null,initialize:function(a){return this.handler=a.doubleClickZoom},isEnabled:function(){return this.handler.isEnabled()},enable:function(){this.handler.enable()},disable:function(){this.handler.disable()},CLASS_NAME:"GeoGlobe.Handler.DoubleClickZoomHandler"});
GeoGlobe.Handler.DragPanHandler=GeoGlobe.Class(GeoGlobe.Handler,{map:null,initialize:function(a){return this.handler=a.dragPan},isActivate:function(){return this.handler.isActive()},isEnabled:function(){return this.handler.isEnabled()},enable:function(){this.handler.enable()},disable:function(){this.handler.disable()},CLASS_NAME:"GeoGlobe.Handler.DragPanHandler"});
...
GeoGlobe.Handler.KeyboardHandler=GeoGlobe.Class(GeoGlobe.Handler,{map:null,initialize:function(a){return this.handler=a.keyboard},isEnabled:function(){return this.handler.isEnabled()},enable:function(){this.handler.enable()},disable:function(){this.handler.disable()},CLASS_NAME:"GeoGlobe.Handler.KeyboardHandler"});
GeoGlobe.Handler.ScrollZoomHandler=GeoGlobe.Class(GeoGlobe.Handler,{map:null,initialize:function(a){return this.handler=a.scrollZoom},isEnabled:function(){return this.handler.isEnabled()},enable:function(){this.handler.enable()},disable:function(){this.handler.disable()},CLASS_NAME:"GeoGlobe.Handler.ScrollZoomHandler"});
GeoGlobe.Handler.TouchZoomRotateHandler=GeoGlobe.Class(GeoGlobe.Handler,{map:null,initialize:function(a){return this.handler=a.touchZoomRotate},isEnabled:function(){return this.handler.isEnabled()},enable:function(){this.handler.enable()},disable:function(){this.handler.disable()},disableRotation:function(){this.handler.disable()},enableRotation:function(){this.handler.disable()},CLASS_NAME:"GeoGlobe.Handler.TouchZoomRotateHandler"});
...
CLASS_NAME:"GeoGlobe.Geometry.LineString"});GeoGlobe.Geometry.LineString.createCurveLine=function(a){for(var b=[],c=0;c<a.length-1;c++){var d=GeoGlobe.Geometry.LineString.getCurveCoordinatesByTwoPoints(a[c],a[c+1]);d&&d.length>0&&(b=b.concat(d))}return new Geo.Geometry.LineString(b)};
...
b.parameters[c])},Constraint:function(a,b){if(!b.constraints)b.constraints={};var c=a.getAttribute("name");b.constraints[c]={};this.readChildNodes(a,b.constraints[c])},Value:function(a,b){b[this.getChildValue(a)]=!0},OutputFormat:function(a,b){b.formats.push({value:this.getChildValue(a)});this.readChildNodes(a,b)},WGS84BoundingBox:function(a,b){var c={};c.crs=a.getAttribute("crs");if(!b.BoundingBox)b.BoundingBox=[];b.BoundingBox?b.BoundingBox.push(c):(b.projection=c.crs,c=b);this.readChildNodes(a,
...
"$1:$3")===c.projection){h=d.tileMatrixSets[e.tileMatrixSetLinks[f].tileMatrixSet];break}}else e.tileMatrixSetLinks.length>=1&&(h=d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet]);if(!h)throw Error("matrixSet not found");var l=[];c.styleName&&c.styleName!=""?l[0]=c.styleName:this.GetStyleName(function(a){l=a});(f=c.requestEncoding)||(f="KVP");f=[];g=c.params||{};delete c.params;for(var j=0,m=e.dimensions.length;j<m;j++){var n=e.dimensions[j];f.push(n.identifier);g.hasOwnProperty(n.identifier)||
(g[n.identifier]=n["default"])}for(var p=c.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),q=c.units||(p==="EPSG:4326"?"degrees":"m"),o=[],s,r,c=[],m=e.tileMatrixSetLinks,g=function(a){o.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[q]);if(!s||s>a)s=a;if(!r||r<a)r=a},n=0,j=m.length;n<j;n++)if(f=m[n],f.tileMatrixSet===h.identifier){if(f.tileMatrixSetLimits){for(var j={},n=0,t=h.matrixIds.length;n<t;n++)j[h.matrixIds[n].identifier]=h.matrixIds[n];n=
0;for(t=f.tileMatrixSetLimits.length;n<t;n++)m=j[f.tileMatrixSetLimits[n].tileMatrix],c.push(m),g(m.scaleDenominator)}else{n=0;for(t=h.matrixIds.length;n<t;n++)g(h.matrixIds[n].scaleDenominator)}break}o.sort(function(a,b){return b-a});var u="",b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,TILEMATRIXSET:h.identifier,FORMAT:"protobuf",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"}),u=a.endsWith("?")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;
GeoGlobe.Util.randomStr(10);if(e.bounds)var v=[e.bounds._sw.lng,e.bounds._sw.lat,e.bounds._ne.lng,e.bounds._ne.lat];var z=d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet].matrixIds[0].identifier,x=[];this.GetStyle(l[0],function(a){var b={name:e.identifier,sprite:a.sprite?GeoGlobe.ProxyHost+a.sprite:"",glyphs:a.glyphs?GeoGlobe.ProxyHost+a.glyphs:"",styleName:a.styleName,srs:p,bbox:v,format:e.formats,zoomoffset:z};if(a.styleData)for(var c=0;c<a.styleData.layers.length;c++)a.styleData.layers[c].metadata=
b,a.styleData.layers[c].source={type:"vector",tiles:[u]},x[c]=a.styleData.layers[c];else for(c=0;c<a.layers.length;c++)a.layers[c].source={type:"vector",tiles:[u]},x[c]=a.layers[c]},function(){alert("WMTS\u670d\u52a1\u8bf7\u6c42\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u670d\u52a1\u662f\u5426\u6b63\u5e38\u8fd0\u884c\u6216\u8bf7\u6c42\u5730\u5740\u662f\u5426\u6b63\u786e\u3002\n\u8bf7\u6c42\u5730\u5740\uff1a"+a+"\n\u64cd\u4f5c\u7c7b\u578b\uff1aGetCapabilities")});return x},createLayer:function(a,b){var c=
this.getVTSCapabilities(a);return this.createLayerOption(a,c,b?{layer:b.layer?b.layer:c.contents.layers[0].identifier,styleName:b.styleName?b.styleName:""}:{layer:c.contents.layers[0].identifier})},createLayers:function(a){for(var b=this.getVTSCapabilities(a),c=b.contents.layers,d=[],e=0;e<c.length;e++){var f=this.createLayerOption(a,b,{layer:c[e].identifier});d.push(f)}return d},GetStyleName:function(a,b){var c=this.url,d={REQUEST:"GetStyle",SERVICE:"WMTS",VERSION:"1.0.0"};b||(b=function(){this.failFn(d.REQUEST)});
GeoGlobe.Request.GET({url:c,params:d,scope:this,async:!1,success:function(c){c=c.responseText;if(!c)return b(),!1;var c=(new GeoGlobe.Format.JSON).read(c),d=[];if(c.style)for(var g=0;g<c.style.length;g++)d.push(c.style[g].styleName);else if(c.styleName)for(g=0;g<c.styleName.length;g++)d.push(c.styleName[g]);a(d)},failure:b})},GetStyle:function(a,b,c){var d=this.url;if(a==""||a==void 0)alert("\u8bf7\u67e5\u770b\u6837\u5f0f\u540d\u79f0\u662f\u5426\u5b58\u5728");else{var e={REQUEST:"GetStyle",SERVICE:"WMTS",
VERSION:"1.0.0",STYLENAME:a};c||(c=function(){this.failFn(e.REQUEST)});GeoGlobe.Request.GET({url:d,params:e,scope:this,async:!1,success:function(a){a=a.responseText;if(!a)return c(),!1;a=(new GeoGlobe.Format.JSON).read(a);b(a)},failure:c})}},getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];d!=null&&typeof d!="function"&&b.push(c+"="+d)}return b.join("&")},CLASS_NAME:"GeoGlobe.Format.VTS"});
...
u;t++)p=l[g.tileMatrixSetLimits[t].tileMatrix],c.push(p),n(p.scaleDenominator)}else{t=0;for(u=j.matrixIds.length;t<u;t++)n(j.matrixIds[t].scaleDenominator)}break}o.sort(function(a,b){return b-a});c="";b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,STYLE:m.identifier,TILEMATRIXSET:j.identifier,FORMAT:h,TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});c=a.endsWith("?")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;a=GeoGlobe.Util.randomStr(10);if(e.bounds)var v=
[e.bounds._sw.lng,e.bounds._sw.lat,e.bounds._ne.lng,e.bounds._ne.lat];return{id:"layer_"+e.identifier+"_"+a,type:"raster",source:{type:"raster",tiles:[c],tileSize:256},metadata:{name:e.identifier,srs:f,bbox:v,format:e.formats,zoomoffset:d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet].matrixIds[0].identifier},paint:{"raster-opacity":1}}},createLayer:function(a,b){var c=this.getWMTSCapabilities(a);return this.createLayerOption(a,c,b?{layer:b.layer}:{layer:c.contents.layers[0].identifier})},
createLayers:function(a){for(var b=this.getWMTSCapabilities(a),c=b.contents.layers,d=[],e=0;e<c.length;e++){var f=this.createLayerOption(a,b,{layer:c[e].identifier});d.push(f)}return d},getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];d!=null&&typeof d!="function"&&b.push(c+"="+d)}return b.join("&")},CLASS_NAME:"GeoGlobe.Format.WMTS"});
...
d.styles.length)e=d.styles[0].name;var f=eval(d.srs),g,h;for(h in f)g=h;h="";c.isTile?(c=this.getParameterString({SERVICE:"WMS",REQUEST:"GetMap",VERSION:"1.1.1",LAYERS:d.name,styles:e,FORMAT:b,TRANSPARENT:!0,BBOX:"{bbox-epsg-3857}",WIDTH:"256",HEIGHT:"256",SRS:g}),h=a.endsWith("?")?a+c:a+"?"+c,h=GeoGlobe.appendToProxy(h),a=GeoGlobe.Util.randomStr(10),d={id:"layer_"+d.name+"_"+a,type:"raster",source:{type:"raster",tiles:[h],tileSize:256},metadata:{name:d.name,srs:g,bbox:d.bbox,format:b},paint:{"raster-opacity":1}}):
d=new GeoGlobe.Layer.WMS({url:a,layer:d.name,format:b,version:"1.1.1",SRS:g,styles:e,bbox:d.bbox,isTile:!1});return d},createLayer:function(a,b,c){this.url=a;var c=c===void 0||c?!0:!1,d=this.getWMSCapabilities(a);return this.createLayerOption(a,d,{layer:b&&b.layer?b.layer:d.capability.layers[0].name,isTile:c})},createLayers:function(a,b){if(b===void 0||b){for(var c=this.getWMSCapabilities(a),d=c.capability.layers,e=[],f=0;f<d.length;f++){var g=this.createLayerOption(a,c,{layer:d[f].name});e.push(g)}return e}},
getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];d!=null&&typeof d!="function"&&b.push(c+"="+d)}return b.join("&")},CLASS_NAME:"GeoGlobe.Format.WMS"});GeoGlobe.Format.WMSCapabilities=GeoGlobe.Class4OL(GeoGlobe.Format.XML.VersionedOGC,{defaultVersion:"1.1.1",profile:null,CLASS_NAME:"GeoGlobe.Format.WMSCapabilities"});
...
source:g.id},source:{type:"raster",tiles:g.url,tileSize:256}};g.matrixSet=h;g.identifier=d.identifier;g.boundingBox=d.BoundingBox;return g},CLASS_NAME:"GeoGlobe.Format.WMTSCapabilities"});
...
"";if(n(b)>0)for(var f in b){var g;if(!(g=m(b,f)))if(g=c!="")g=c===""?f:c+"."+f,g=!(a.jsonPropertiesFilter.length==0||g==""||d(a.jsonPropertiesFilter,b,f,g));if(!g){var h=b[f];g=p(h);if(h==null||h==void 0)e+=j(h,f,g,!0);else if(h instanceof Object)if(h instanceof Array){var s=f,y=c,w="";if(h.length==0)w+=j(h,s,g,!0);else for(g=0;g<h.length;g++)w+=j(h[g],s,p(h[g]),!1),w+=o(h[g],y===""?s:y+"."+s),w+=l(h[g],s);e+=w}else h instanceof Date?(e+=j(h,f,g,!1),e+=h.toISOString(),e+=l(h,f)):n(h)>0||h.__text!=
...
GeoGlobe.Analysis.GetFeature=GeoGlobe.Class4OL({url:null,type:"intersection",_reqStrTemplate:"{'GetFeature': {'service': 'OverlapService','version': '1.0.0','dataSource':'${sourceInputs}','Query': [{'typeName':'${dataInputs}'}],'maxFeatures': '','startPosition': '','resultType': ''}}",initialize:function(a,b){this.url=a;GeoGlobe.Util.extend(this,b)},_buildReqStr:function(){return GeoGlobe.String.format(this._reqStrTemplate,{type:this.type,dataInputs:this.typeName,sourceInputs:this.DataSource})},startAnalysis:function(){if(this._checkSet())return!1;
...
'<wfs:Update typeName="'+b+'" handle="Update '+d+'">'+e+f+"</wfs:Update>"}return c},_getUpdatePropertyString:function(a){var b="",c;for(c in a.data)c!="OID"&&(b+="<wfs:Property><wfs:Name><![CDATA["+c+"]]\></wfs:Name><wfs:Value><![CDATA["+(a.data[c]?a.data[c]:"")+"]]\></wfs:Value></wfs:Property>");b+="<wfs:Property><wfs:Name>Geometry</wfs:Name><wfs:Value>"+this._getGeometryStringByFeature(a)+"</wfs:Value></wfs:Property>";return b},_getGeometryStringByFeature:function(a){var b=new GeoGlobe.Format.GML({xy:this.xy});
...
GeoGlobe.ElementContainer=GeoGlobe.Class4OL({map:null,initialize:function(a){GeoGlobe.Util.extend(this,a)},addTo:function(a){this.map=a;var b=a.getCanvasContainer();if(!a.eleContainer)b=GeoGlobe.DOM.create("div","geoglobe-element-container",b),b.style.width=a.getCanvas().style.width,b.style.height=a.getCanvas().style.height,b.style.position="absolute",a.eleContainer=b;this.container=GeoGlobe.DOM.create("div",null,a.eleContainer);this.container.style.width=a.getCanvas().style.width;this.container.style.height=
a.getCanvas().style.height;this.container.style.position="absolute";a.isIntScrollZoom=!0},getElMap:function(){return this.elmap},remove:function(){},CLASS_NAME:"GeoGlobe.ElementContainer"});
GeoGlobe.MaptalksEle=GeoGlobe.Class4OL(GeoGlobe.ElementContainer,{map:null,container:null,elmap:null,elmapOptions:null,initialize:function(){GeoGlobe.ElementContainer.prototype.initialize.apply(this,arguments)},addTo:function(){GeoGlobe.ElementContainer.prototype.addTo.apply(this,arguments);this.container.id="GeoGlobe_MaptalksEle";this.container.className="geoglobe-maptalks-container";if(window.maptalks&&window.maptalks.Map){GeoGlobe.MaptalksEle.overrideMapTalksFunc();var a=this.map.getCenter(),a=
GeoGlobe.Util.extend({zoom:this.map.getZoom()+1,center:[a.lng,a.lat]},this.elmapOptions);this.elmap=new maptalks.Map(this.container.id,a);this._bindEvent()}else console.log("\u4f7f\u7528\u524d\u7f6emaptalks\u5bb9\u5668\uff0c\u9700\u5f15\u5165maptalks\u5730\u56fe\u5e93\u3002")},_bindEvent:function(){var a=this.map;this._movestart=GeoGlobe.Function.bind(function(){if(this._zooming)this._zooming=!1,this._iszoomend=!0},this);this._move=GeoGlobe.Function.bind(function(){if(!(this._zooming==!0||this._rotating==
!0))this.elmap._moving=!0,this.syncElmapCenter()},this);this._moveend=GeoGlobe.Function.bind(function(a){this.elmap._moving=!1;this._rotating=this._zooming=this.elmap._dragRotating=!1;var c=this.map.getZoom();Math.ceil(c)!==c&&this.map.setZoom(Math.ceil(c));this._iszoomend?(this._iszoomend=!1,c=this.map.getZoom()+1,a=a.target.scrollZoom._pos?a.target.scrollZoom._pos:a.point,a=new maptalks.Point(a.x,a.y),this.elmap._zoomTo(c,a),this.elmap._zooming=!1,this.elmap._getRenderer().onZoomEnd(),this.elmap._fireEvent("zoomend",
{from:this.elmap._startZoomVal,to:c}),this.syncElmapCenter()):(c=this.map.getCenter(),this.elmap.setCenter([c.lng,c.lat]))},this);this._rotatestart=GeoGlobe.Function.bind(function(){this._rotating=!0;this.elmap._dragRotating=!0},this);this._rotate=GeoGlobe.Function.bind(function(){this.syncElmapRotate()},this);this._zoomstart=GeoGlobe.Function.bind(function(a){this._zooming=!0;this.elmap._moving=!1;var c=this.map.getZoom()+1,a=a.target.scrollZoom._pos?a.target.scrollZoom._pos:a.point,d=new maptalks.Point(a.x,
a.y);this.origin_lnglat=this.map.unproject(a);this.elmap.onZoomStart(c,d)},this);this._zoom=GeoGlobe.Function.bind(function(a){var c=this.map.getCenter(),d=this.map.getZoom()+1;if(this.elmap._zoomLevel!==d){var a=a.target.scrollZoom._pos?a.target.scrollZoom._pos:a.point,e=this.map.project(this.origin_lnglat);if(a.x!==Math.round(e.x)||a.y!==Math.round(e.y))this.elmap._zooming=!1;a=new maptalks.Point(a.x,a.y);this.elmap.onZooming(d,a)}d=this.elmap.getCenter();(c.lng-d.x>2||c.lng-d.x<-2)&&this.syncElmapCenter()},
this);this._zoomend=GeoGlobe.Function.bind(function(){this._zooming=!1;this._iszoomend=!0},this);a.on("movestart",this._movestart);a.on("move",this._move);a.on("moveend",this._moveend);a.on("rotatestart",this._rotatestart);a.on("rotate",this._rotate);a.on("zoomstart",this._zoomstart);a.on("zoom",this._zoom);a.on("zoomend",this._zoomend)},syncElmapCenter:function(){var a=this.map.getCenter(),a=[a.lng,a.lat];if(!a)return!1;a=new maptalks.Coordinate(a);this.elmap._setPrjCenter(this.elmap.getProjection().project(a))},
...
this._rotatestart);a.off("rotate",this._rotate);a.off("zoomstart",this._zoomstart);a.off("zoom",this._zoom);a.off("zoomend",this._zoomend);this.container.parentNode.removeChild(this.container);this.container=null;this.elmap.remove();this.map=this.elmap=null},CLASS_NAME:"GeoGlobe.MaptalksEle"});
